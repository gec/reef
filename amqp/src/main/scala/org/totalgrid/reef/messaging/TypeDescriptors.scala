...
object Descriptors {
  ...
  def serviceRequest() = new ITypeDescriptor[org.totalgrid.reef.proto.Envelope.ServiceRequest] {
  ...
  def serviceResponse() = new ITypeDescriptor[org.totalgrid.reef.proto.Envelope.ServiceResponse] {
  ...
  def serviceNotification() = new ITypeDescriptor[org.totalgrid.reef.proto.Envelope.ServiceNotification] {
