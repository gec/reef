 ...
 *  - A field devices is reporting a bad value (wildly oscillating or pinned to 0) and is generating spurious
 ...
 */
trait MeasurementOverrideService {
   ...
   */
  @throws(classOf[ReefServiceException])
  def setPointOverriden(point: Point, measurement: Measurement): MeasOverride
