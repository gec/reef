...
public interface AuthTokenService {
     ...
     */
    public String createNewAuthorizationToken(String agentName, String passwordUnencrypted) throws ReefServiceException;

    /**
     * Revoke the specified authorization token. This means all future requests using this authorization token will fail.
     * @param authorizationToken
     */
    public void deleteAuthorizationToken(String authorizationToken) throws ReefServiceException;
}