...
object OptionalProtos {
  ...
  implicit def proto2OptAlarmsAlarm(a: org.totalgrid.reef.api.proto.Alarms.Alarm): OptAlarmsAlarm = new OptAlarmsAlarm(Some(a))
  class OptAlarmsAlarm(real: Option[org.totalgrid.reef.api.proto.Alarms.Alarm]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptAlarmsAlarmSelect(a: org.totalgrid.reef.api.proto.Alarms.AlarmSelect): OptAlarmsAlarmSelect = new OptAlarmsAlarmSelect(Some(a))
  class OptAlarmsAlarmSelect(real: Option[org.totalgrid.reef.api.proto.Alarms.AlarmSelect]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptAlarmsAlarmList(a: org.totalgrid.reef.api.proto.Alarms.AlarmList): OptAlarmsAlarmList = new OptAlarmsAlarmList(Some(a))
  class OptAlarmsAlarmList(real: Option[org.totalgrid.reef.api.proto.Alarms.AlarmList]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptAlarmsEventConfig(a: org.totalgrid.reef.api.proto.Alarms.EventConfig): OptAlarmsEventConfig = new OptAlarmsEventConfig(Some(a))
  class OptAlarmsEventConfig(real: Option[org.totalgrid.reef.api.proto.Alarms.EventConfig]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptApplicationHeartbeatConfig(a: org.totalgrid.reef.api.proto.Application.HeartbeatConfig): OptApplicationHeartbeatConfig = new OptApplicationHeartbeatConfig(Some(a))
  class OptApplicationHeartbeatConfig(real: Option[org.totalgrid.reef.api.proto.Application.HeartbeatConfig]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptApplicationApplicationConfig(a: org.totalgrid.reef.api.proto.Application.ApplicationConfig): OptApplicationApplicationConfig = new OptApplicationApplicationConfig(Some(a))
  class OptApplicationApplicationConfig(real: Option[org.totalgrid.reef.api.proto.Application.ApplicationConfig]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptAuthAgent(a: org.totalgrid.reef.api.proto.Auth.Agent): OptAuthAgent = new OptAuthAgent(Some(a))
  class OptAuthAgent(real: Option[org.totalgrid.reef.api.proto.Auth.Agent]) extends OptionalStruct(real) {
    val uuid = new OptModelReefUUID(optionally(_.hasUuid, _.getUuid))
  ...
  implicit def proto2OptAuthPermission(a: org.totalgrid.reef.api.proto.Auth.Permission): OptAuthPermission = new OptAuthPermission(Some(a))
  class OptAuthPermission(real: Option[org.totalgrid.reef.api.proto.Auth.Permission]) extends OptionalStruct(real) {
    val uid = optionally(_.hasUid, _.getUid)
    val allow = optionally(_.hasAllow, _.getAllow)
    val resource = optionally(_.hasResource, _.getResource)
    val verb = optionally(_.hasVerb, _.getVerb)
  }
  implicit def proto2OptAuthPermissionSet(a: org.totalgrid.reef.api.proto.Auth.PermissionSet): OptAuthPermissionSet = new OptAuthPermissionSet(Some(a))
  class OptAuthPermissionSet(real: Option[org.totalgrid.reef.api.proto.Auth.PermissionSet]) extends OptionalStruct(real) {
    val uuid = new OptModelReefUUID(optionally(_.hasUuid, _.getUuid))
    val name = optionally(_.hasName, _.getName)
  ...
  implicit def proto2OptAuthAuthToken(a: org.totalgrid.reef.api.proto.Auth.AuthToken): OptAuthAuthToken = new OptAuthAuthToken(Some(a))
  class OptAuthAuthToken(real: Option[org.totalgrid.reef.api.proto.Auth.AuthToken]) extends OptionalStruct(real) {
    val uid = optionally(_.hasUid, _.getUid)
  ...
  implicit def proto2OptCommandsUserCommandRequest(a: org.totalgrid.reef.api.proto.Commands.UserCommandRequest): OptCommandsUserCommandRequest = new OptCommandsUserCommandRequest(Some(a))
  class OptCommandsUserCommandRequest(real: Option[org.totalgrid.reef.api.proto.Commands.UserCommandRequest]) extends OptionalStruct(real) {
    val uid = optionally(_.hasUid, _.getUid)
  ...
  implicit def proto2OptCommandsCommandAccess(a: org.totalgrid.reef.api.proto.Commands.CommandAccess): OptCommandsCommandAccess = new OptCommandsCommandAccess(Some(a))
  class OptCommandsCommandAccess(real: Option[org.totalgrid.reef.api.proto.Commands.CommandAccess]) extends OptionalStruct(real) {
    val uid = optionally(_.hasUid, _.getUid)
  ...
  implicit def proto2OptCommandsCommandRequest(a: org.totalgrid.reef.api.proto.Commands.CommandRequest): OptCommandsCommandRequest = new OptCommandsCommandRequest(Some(a))
  class OptCommandsCommandRequest(real: Option[org.totalgrid.reef.api.proto.Commands.CommandRequest]) extends OptionalStruct(real) {
    val name = optionally(_.hasName, _.getName)
  ...
  implicit def proto2OptCommandsCommandResponse(a: org.totalgrid.reef.api.proto.Commands.CommandResponse): OptCommandsCommandResponse = new OptCommandsCommandResponse(Some(a))
  class OptCommandsCommandResponse(real: Option[org.totalgrid.reef.api.proto.Commands.CommandResponse]) extends OptionalStruct(real) {
    val correlationId = optionally(_.getCorrelationId)
    val status = optionally(_.getStatus)
  }
  implicit def proto2OptEventsEvent(a: org.totalgrid.reef.api.proto.Events.Event): OptEventsEvent = new OptEventsEvent(Some(a))
  class OptEventsEvent(real: Option[org.totalgrid.reef.api.proto.Events.Event]) extends OptionalStruct(real) {
    val uid = optionally(_.hasUid, _.getUid)
    val eventType = optionally(_.hasEventType, _.getEventType)
  ...
  implicit def proto2OptEventsEventSelect(a: org.totalgrid.reef.api.proto.Events.EventSelect): OptEventsEventSelect = new OptEventsEventSelect(Some(a))
  class OptEventsEventSelect(real: Option[org.totalgrid.reef.api.proto.Events.EventSelect]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptEventsEventList(a: org.totalgrid.reef.api.proto.Events.EventList): OptEventsEventList = new OptEventsEventList(Some(a))
  class OptEventsEventList(real: Option[org.totalgrid.reef.api.proto.Events.EventList]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptEventsLog(a: org.totalgrid.reef.api.proto.Events.Log): OptEventsLog = new OptEventsLog(Some(a))
  class OptEventsLog(real: Option[org.totalgrid.reef.api.proto.Events.Log]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptFEPIpPort(a: org.totalgrid.reef.api.proto.FEP.IpPort): OptFEPIpPort = new OptFEPIpPort(Some(a))
  class OptFEPIpPort(real: Option[org.totalgrid.reef.api.proto.FEP.IpPort]) extends OptionalStruct(real) {
    val address = optionally(_.getAddress)
    val port = optionally(_.getPort)
    val mode = optionally(_.hasMode, _.getMode)
    val network = optionally(_.hasNetwork, _.getNetwork)
  }
  implicit def proto2OptFEPSerialPort(a: org.totalgrid.reef.api.proto.FEP.SerialPort): OptFEPSerialPort = new OptFEPSerialPort(Some(a))
  class OptFEPSerialPort(real: Option[org.totalgrid.reef.api.proto.FEP.SerialPort]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptFEPCommChannel(a: org.totalgrid.reef.api.proto.FEP.CommChannel): OptFEPCommChannel = new OptFEPCommChannel(Some(a))
  class OptFEPCommChannel(real: Option[org.totalgrid.reef.api.proto.FEP.CommChannel]) extends OptionalStruct(real) {
    val uuid = new OptModelReefUUID(optionally(_.hasUuid, _.getUuid))
    val name = optionally(_.hasName, _.getName)
  ...
  implicit def proto2OptFEPCommEndpointRouting(a: org.totalgrid.reef.api.proto.FEP.CommEndpointRouting): OptFEPCommEndpointRouting = new OptFEPCommEndpointRouting(Some(a))
  class OptFEPCommEndpointRouting(real: Option[org.totalgrid.reef.api.proto.FEP.CommEndpointRouting]) extends OptionalStruct(real) {
    val serviceRoutingKey = optionally(_.hasServiceRoutingKey, _.getServiceRoutingKey)
  }
  implicit def proto2OptFEPFrontEndProcessor(a: org.totalgrid.reef.api.proto.FEP.FrontEndProcessor): OptFEPFrontEndProcessor = new OptFEPFrontEndProcessor(Some(a))
  class OptFEPFrontEndProcessor(real: Option[org.totalgrid.reef.api.proto.FEP.FrontEndProcessor]) extends OptionalStruct(real) {
    val uuid = new OptModelReefUUID(optionally(_.hasUuid, _.getUuid))
  ...
  implicit def proto2OptFEPEndpointOwnership(a: org.totalgrid.reef.api.proto.FEP.EndpointOwnership): OptFEPEndpointOwnership = new OptFEPEndpointOwnership(Some(a))
  class OptFEPEndpointOwnership(real: Option[org.totalgrid.reef.api.proto.FEP.EndpointOwnership]) extends OptionalStruct(real) {
    val points = optionally(_.getPointsList.toList)
    val commands = optionally(_.getCommandsList.toList)
  }
  implicit def proto2OptFEPCommEndpointConfig(a: org.totalgrid.reef.api.proto.FEP.CommEndpointConfig): OptFEPCommEndpointConfig = new OptFEPCommEndpointConfig(Some(a))
  class OptFEPCommEndpointConfig(real: Option[org.totalgrid.reef.api.proto.FEP.CommEndpointConfig]) extends OptionalStruct(real) {
    val uuid = new OptModelReefUUID(optionally(_.hasUuid, _.getUuid))
    val name = optionally(_.hasName, _.getName)
    val entity = new OptModelEntity(optionally(_.hasEntity, _.getEntity))
  ...
  implicit def proto2OptFEPCommEndpointConnection(a: org.totalgrid.reef.api.proto.FEP.CommEndpointConnection): OptFEPCommEndpointConnection = new OptFEPCommEndpointConnection(Some(a))
  class OptFEPCommEndpointConnection(real: Option[org.totalgrid.reef.api.proto.FEP.CommEndpointConnection]) extends OptionalStruct(real) {
    val uid = optionally(_.hasUid, _.getUid)
  ...
  implicit def proto2OptMappingMeasMap(a: org.totalgrid.reef.api.proto.Mapping.MeasMap): OptMappingMeasMap = new OptMappingMeasMap(Some(a))
  class OptMappingMeasMap(real: Option[org.totalgrid.reef.api.proto.Mapping.MeasMap]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptMappingCommandMap(a: org.totalgrid.reef.api.proto.Mapping.CommandMap): OptMappingCommandMap = new OptMappingCommandMap(Some(a))
  class OptMappingCommandMap(real: Option[org.totalgrid.reef.api.proto.Mapping.CommandMap]) extends OptionalStruct(real) {
    val _type = optionally(_.getType)
    val index = optionally(_.getIndex)
  ...
  implicit def proto2OptMappingIndexMapping(a: org.totalgrid.reef.api.proto.Mapping.IndexMapping): OptMappingIndexMapping = new OptMappingIndexMapping(Some(a))
  class OptMappingIndexMapping(real: Option[org.totalgrid.reef.api.proto.Mapping.IndexMapping]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptMeasurementsDetailQual(a: org.totalgrid.reef.api.proto.Measurements.DetailQual): OptMeasurementsDetailQual = new OptMeasurementsDetailQual(Some(a))
  class OptMeasurementsDetailQual(real: Option[org.totalgrid.reef.api.proto.Measurements.DetailQual]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptMeasurementsQuality(a: org.totalgrid.reef.api.proto.Measurements.Quality): OptMeasurementsQuality = new OptMeasurementsQuality(Some(a))
  class OptMeasurementsQuality(real: Option[org.totalgrid.reef.api.proto.Measurements.Quality]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptMeasurementsMeasurement(a: org.totalgrid.reef.api.proto.Measurements.Measurement): OptMeasurementsMeasurement = new OptMeasurementsMeasurement(Some(a))
  class OptMeasurementsMeasurement(real: Option[org.totalgrid.reef.api.proto.Measurements.Measurement]) extends OptionalStruct(real) {
    val name = optionally(_.hasName, _.getName)
    val _type = optionally(_.getType)
    val intVal = optionally(_.hasIntVal, _.getIntVal)
    val doubleVal = optionally(_.hasDoubleVal, _.getDoubleVal)
  ...
  implicit def proto2OptMeasurementsMeasurementBatch(a: org.totalgrid.reef.api.proto.Measurements.MeasurementBatch): OptMeasurementsMeasurementBatch = new OptMeasurementsMeasurementBatch(Some(a))
  class OptMeasurementsMeasurementBatch(real: Option[org.totalgrid.reef.api.proto.Measurements.MeasurementBatch]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptMeasurementsMeasArchiveUnit(a: org.totalgrid.reef.api.proto.Measurements.MeasArchiveUnit): OptMeasurementsMeasArchiveUnit = new OptMeasurementsMeasArchiveUnit(Some(a))
  class OptMeasurementsMeasArchiveUnit(real: Option[org.totalgrid.reef.api.proto.Measurements.MeasArchiveUnit]) extends OptionalStruct(real) {
    val intVal = optionally(_.hasIntVal, _.getIntVal)
    val doubleVal = optionally(_.hasDoubleVal, _.getDoubleVal)
    val boolVal = optionally(_.hasBoolVal, _.getBoolVal)
    val stringVal = optionally(_.hasStringVal, _.getStringVal)
  ...
  implicit def proto2OptMeasurementsMeasArchive(a: org.totalgrid.reef.api.proto.Measurements.MeasArchive): OptMeasurementsMeasArchive = new OptMeasurementsMeasArchive(Some(a))
  class OptMeasurementsMeasArchive(real: Option[org.totalgrid.reef.api.proto.Measurements.MeasArchive]) extends OptionalStruct(real) {
    val meas = optionally(_.getMeasList.toList.map { i => new OptMeasurementsMeasArchiveUnit(Some(i)) })
  }
  implicit def proto2OptMeasurementsMeasurementSnapshot(a: org.totalgrid.reef.api.proto.Measurements.MeasurementSnapshot): OptMeasurementsMeasurementSnapshot = new OptMeasurementsMeasurementSnapshot(Some(a))
  class OptMeasurementsMeasurementSnapshot(real: Option[org.totalgrid.reef.api.proto.Measurements.MeasurementSnapshot]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptMeasurementsMeasurementHistory(a: org.totalgrid.reef.api.proto.Measurements.MeasurementHistory): OptMeasurementsMeasurementHistory = new OptMeasurementsMeasurementHistory(Some(a))
  class OptMeasurementsMeasurementHistory(real: Option[org.totalgrid.reef.api.proto.Measurements.MeasurementHistory]) extends OptionalStruct(real) {
    val pointName = optionally(_.getPointName)
  ...
  implicit def proto2OptModelReefUUID(a: org.totalgrid.reef.api.proto.Model.ReefUUID): OptModelReefUUID = new OptModelReefUUID(Some(a))
  class OptModelReefUUID(real: Option[org.totalgrid.reef.api.proto.Model.ReefUUID]) extends OptionalStruct(real) {
    val uuid = optionally(_.getUuid)
  }
  implicit def proto2OptModelEntity(a: org.totalgrid.reef.api.proto.Model.Entity): OptModelEntity = new OptModelEntity(Some(a))
  class OptModelEntity(real: Option[org.totalgrid.reef.api.proto.Model.Entity]) extends OptionalStruct(real) {
    val uuid = new OptModelReefUUID(optionally(_.hasUuid, _.getUuid))
  ...
  implicit def proto2OptModelRelationship(a: org.totalgrid.reef.api.proto.Model.Relationship): OptModelRelationship = new OptModelRelationship(Some(a))
  class OptModelRelationship(real: Option[org.totalgrid.reef.api.proto.Model.Relationship]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptModelEntityEdge(a: org.totalgrid.reef.api.proto.Model.EntityEdge): OptModelEntityEdge = new OptModelEntityEdge(Some(a))
  class OptModelEntityEdge(real: Option[org.totalgrid.reef.api.proto.Model.EntityEdge]) extends OptionalStruct(real) {
    val uuid = new OptModelReefUUID(optionally(_.hasUuid, _.getUuid))
  ...
  implicit def proto2OptModelEntityAttributes(a: org.totalgrid.reef.api.proto.Model.EntityAttributes): OptModelEntityAttributes = new OptModelEntityAttributes(Some(a))
  class OptModelEntityAttributes(real: Option[org.totalgrid.reef.api.proto.Model.EntityAttributes]) extends OptionalStruct(real) {
    val entity = new OptModelEntity(optionally(_.hasEntity, _.getEntity))
    val attributes = optionally(_.getAttributesList.toList.map { i => new OptUtilsAttribute(Some(i)) })
  }
  implicit def proto2OptModelPoint(a: org.totalgrid.reef.api.proto.Model.Point): OptModelPoint = new OptModelPoint(Some(a))
  class OptModelPoint(real: Option[org.totalgrid.reef.api.proto.Model.Point]) extends OptionalStruct(real) {
    val uuid = new OptModelReefUUID(optionally(_.hasUuid, _.getUuid))
    val name = optionally(_.hasName, _.getName)
  ...
  implicit def proto2OptModelCommand(a: org.totalgrid.reef.api.proto.Model.Command): OptModelCommand = new OptModelCommand(Some(a))
  class OptModelCommand(real: Option[org.totalgrid.reef.api.proto.Model.Command]) extends OptionalStruct(real) {
    val uuid = new OptModelReefUUID(optionally(_.hasUuid, _.getUuid))
    val name = optionally(_.hasName, _.getName)
  ...
  implicit def proto2OptModelConfigFile(a: org.totalgrid.reef.api.proto.Model.ConfigFile): OptModelConfigFile = new OptModelConfigFile(Some(a))
  class OptModelConfigFile(real: Option[org.totalgrid.reef.api.proto.Model.ConfigFile]) extends OptionalStruct(real) {
    val uuid = new OptModelReefUUID(optionally(_.hasUuid, _.getUuid))
    val name = optionally(_.hasName, _.getName)
  ...
  implicit def proto2OptSimMappingMeasSim(a: org.totalgrid.reef.api.proto.SimMapping.MeasSim): OptSimMappingMeasSim = new OptSimMappingMeasSim(Some(a))
  class OptSimMappingMeasSim(real: Option[org.totalgrid.reef.api.proto.SimMapping.MeasSim]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptSimMappingCommandSim(a: org.totalgrid.reef.api.proto.SimMapping.CommandSim): OptSimMappingCommandSim = new OptSimMappingCommandSim(Some(a))
  class OptSimMappingCommandSim(real: Option[org.totalgrid.reef.api.proto.SimMapping.CommandSim]) extends OptionalStruct(real) {
    val name = optionally(_.getName)
    val responseStatus = optionally(_.getResponseStatus)
  }
  implicit def proto2OptSimMappingSimulatorMapping(a: org.totalgrid.reef.api.proto.SimMapping.SimulatorMapping): OptSimMappingSimulatorMapping = new OptSimMappingSimulatorMapping(Some(a))
  class OptSimMappingSimulatorMapping(real: Option[org.totalgrid.reef.api.proto.SimMapping.SimulatorMapping]) extends OptionalStruct(real) {
  ...
  implicit def proto2OptUtilsAttribute(a: org.totalgrid.reef.api.proto.Utils.Attribute): OptUtilsAttribute = new OptUtilsAttribute(Some(a))
  class OptUtilsAttribute(real: Option[org.totalgrid.reef.api.proto.Utils.Attribute]) extends OptionalStruct(real) {
    val name = optionally(_.getName)
  ...
  implicit def proto2OptUtilsAttributeList(a: org.totalgrid.reef.api.proto.Utils.AttributeList): OptUtilsAttributeList = new OptUtilsAttributeList(Some(a))
  class OptUtilsAttributeList(real: Option[org.totalgrid.reef.api.proto.Utils.AttributeList]) extends OptionalStruct(real) {
