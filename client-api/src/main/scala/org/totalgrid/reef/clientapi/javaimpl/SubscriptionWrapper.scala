...
import org.totalgrid.reef.clientapi.sapi.client.{ Subscription => ScalaSubscription }
import org.totalgrid.reef.clientapi.{ SubscriptionEventAcceptor, Subscription }
