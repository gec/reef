...
object ProtoRoutingKeys {
  ...
  def routingKeyOptions(proto: CommEndpointConfig): List[Option[Any]] = {
    hasGet(proto.hasUuid, proto.getUuid.getUuid) ::
  ...
  def routingKeyOptions(proto: Command): List[Option[Any]] = {
    hasGet(proto.hasUuid, proto.getUuid.getUuid) ::
      ...
      hasGet(proto.hasEntity, proto.getEntity.getUuid.getUuid) :: Nil
  }
  ...
  def routingKeyOptions(proto: CommEndpointConnection): List[Option[Any]] = {
    hasGet(proto.hasFrontEnd, proto.getFrontEnd.hasUuid, proto.getFrontEnd.getUuid.getUuid) ::
  ...
  def routingKeyOptions(proto: FrontEndProcessor): List[Option[Any]] = {
    hasGet(proto.hasUuid, proto.getUuid.getUuid) :: Nil
  }
  ...
  def routingKeyOptions(proto: MeasurementProcessingConnection): List[Option[Any]] = {
    hasGet(proto.hasMeasProc, proto.getMeasProc.hasUuid, proto.getMeasProc.getUuid.getUuid) ::
      hasGet(proto.hasUid, proto.getUid) :: Nil
  }
  ...
  def routingKeyOptions(proto: MeasOverride): List[Option[Any]] = {
    ...
    hasGet(proto.hasPoint, proto.getPoint.hasLogicalNode, proto.getPoint.getLogicalNode.hasUuid, proto.getPoint.getLogicalNode.getUuid.getUuid) ::
